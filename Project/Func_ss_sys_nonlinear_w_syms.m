%% Function to create the non-linear state-space system using symbolic substitution

function dxdt = Func_ss_sys_nonlinear_w_syms(t,x,q1,q1_d,q2,q2_d,tau1,tau2,x_dot)
