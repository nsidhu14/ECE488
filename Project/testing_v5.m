...
required_dist = 0.004; % this should be the 4mm distance
...
x_op_each_itteration = zeros(4,1,length(tspan));
...
%         K(:,:,i) = K_lqr;
    ...
    x_op_each_itteration(:,:,t_ind) = x_op(:,:,i); % store value of x_op at current t_ind
    ...
    y_current = l1*sin(q(1))+l2*sin(q(1)+q(2));
